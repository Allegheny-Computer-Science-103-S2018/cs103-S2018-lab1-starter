...
# cs103-S2018-lab1-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 1 in Computer Science 103.
...
textbook, paying close attention to Figures 1.6 and 1.7, and Section 1.5. Please
...
- The `answers.md` file has at least four subsections created with a `##`
  marker.
- The `answers.md` file contains four paragraphs with at least three sentences.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-103-S2018/cs103-S2018-lab1-starter.git
```
...
you can go to the [Computer Science 103 Lab 1
Starter](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-lab1-starter)
...
issue in the
[cs103-S2018-lab-sheets](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-lab-sheets)
